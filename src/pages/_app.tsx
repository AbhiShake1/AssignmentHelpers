    ...
    return (
        <div className='top-0 left-0 right-0'>
            <div className='border-blue-500 border-opacity-25 border m-12 p-4 rounded-2xl shadow-2xl flex flex-row bg-white'>
                <Link href='home' scroll={false} className='p-2 bg-transparent'>
                ...
                <div className='flex flex-row-reverse space-x-4 w-full bg-transparent'>
                    ...
                    <Link href='findFreelancers' scroll={false}
                          className={`hover:text-blue-500 p-2 bg-transparent ${path.includes('findFreelancers') ? 'text-blue-700' : ''}`}>Find
                        Freelancers</Link>
                    {/*<Link href='' className={`hover:text-blue-500 p-2 bg-transparent ${path.includes('findWork') ? 'text-blue-700' : ''}`}>Log in</Link>*/}
                    <Link href='home' scroll={false}
                          className={`hover:text-blue-500 p-2 bg-transparent ${path.includes('home') ? 'text-blue-700' : ''}`}>Home</Link>
                </div>
            </div>
        </div>
    )
