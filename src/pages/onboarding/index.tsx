...
function Index() {
    return (
        <div className='xl:p-32'>
            <div className='px-16 py-8 flex flex-row justify-between space-x-12 items-center'>
                <div className=''>
                    ...
                    <div className='flex flex-row space-x-4'>
                        <button
                            className={`bg-blue-600 px-8 py-4 ${responsiveSubtitle} text-white rounded-2xl hover:bg-blue-900 focus:border-blue-600 md:px-4`}>Hire
                            a freelancer
                        </button>
                        <button type='button'
                                className='flex flex-row items-center border border-gray-500 rounded-2xl px-6 md:px-2 hover:border-blue-700 focus:border-blue-600'>
                            <input placeholder='search freelance work'
                                   className={`bg-transparent outline-none border-none ${responsiveSubtitle}`}/>
            ...
            <div
                className='flex flex-row text-center sm:flex-col xs:flex-col md:flex-col xs:space-y-8 sm:space-y-8 md:space-y-12 lg:space-y-0 xl:space-y-0 lg:flex-row items-center justify-between bg-white p-12 rounded-2xl shadow-2xl w-full my-32'>
                <div className='flex flex-col items-center space-y-2 bg-transparent'>
                    ...
                    <h2 className='text-2xl font-bold bg-transparent text-center'>Create Account</h2>
                    <h2 className='text-lg font-semibold text-gray-500 bg-transparent text-center xs:hidden lg:block'>First
                ...
                <div className='flex flex-col items-center space-y-2 bg-transparent'>
                    ...
                    <h2 className='text-lg font-semibold text-gray-500 bg-transparent xs:hidden lg:block'>Search the
                ...
                <div className='flex flex-col items-center space-y-2 bg-transparent'>
                    ...
                    <h2 className='text-lg font-semibold text-gray-500 bg-transparent xs:hidden lg:block'>Apply or save
            ...
            <div className='flex flex-col space-y-4 items-center'>
                ...
                <div className='text-gray-500 text-center'>
                    ...
                    With a seamless search experience and a vast pool of talented individuals, finding the perfect match
